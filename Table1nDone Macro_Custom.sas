...
EDIT 10/28/22 - Hard coding customization for ECON 771 Assignment 3 to present some variables as sums
...
/*!!!!!!!	Overwrite for sums for HW  !!!!!!!*/
				if Variable = "tagfirmID" then Result = _SUM_;
				if Variable in ("EBene", "thisPlansExistState_F0", "thisPlansExist_F0") then Result = round(_MEAN_, 0.01);
/*!!!!!!!	End Hard Coded edit  !!!!!!!*/
